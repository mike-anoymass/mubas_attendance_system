...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <h3 class="box-title text-center">General Statistics</h3>
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    ...
                    <a href="lecturers/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    ...
                    <a href="programs/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-blue-active">
                    <div class="inner">
                        <?php
                            ...
                            $number = $view->getNumberOfCollectedCertificatesToday();
                            echo "<h3> $number </h3>";
                        ?>

                        <p>Collected certificates Today</p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-alert-circled"></i>
                    </div>
                    <a href="../admin&secretary/students/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
        </div>
